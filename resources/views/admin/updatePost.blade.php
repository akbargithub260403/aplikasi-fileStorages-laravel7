...
@section('judul','Halaman Update Post')
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>
                                ...
                                @endif
                        <div class="body">
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="/update/proses/{{$post->id}}">
                            @method('patch')
                            @csrf
                            ...
                            <div class="form-line">
                            <input type="text" id="email_address_2" autocomplete="off" value="{{$post->judul}}" class="form-control @error('judul') is-invalid @enderror" name="judul">
                                    @error('judul')
                            ...
                            <div class="form-group">
                            <div class="form-line">
                            <input type="text" autocomplete="off" value="{{$post->pembuat}}" class="form-control @error('pembuat') is-invalid @enderror" name="pembuat">
                                    @error('pembuat')
                                        <div class="alert alert-warning invalid-feedback">
                                            <strong>Kesalahan!</strong> {{ $message }}
                                        </div>
                            ...
                            <div class="col-md-3">
                            <select name="prodi" id="" value="{{$post->prodi}}" class="form-control @error('prodi') is-invalid @enderror">
                            ...
                            <div class="form-group">
                            <div class="form-line">
                            <input type="text" autocomplete="off" value="{{$post->keterangan}}" class="form-control @error('keterangan') is-invalid @enderror" name="keterangan">
                            </div>
                            </div>
                            </div>
                            </div>
