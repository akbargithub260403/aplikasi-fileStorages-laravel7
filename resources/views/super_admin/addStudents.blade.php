...
@section('judul','Halaman Add Students')
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            ...
                            @endif
                        <div class="body">
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{ route('insert_students') }}">
                            @csrf
                            <div class="row clearfix">
